...
function playGame(){
    ...
    var totalGuesses = 1;
    while(currentGuess < from || currentGuess > to || (currentGuess != target) || isNaN(currentGuess)){
        if (currentGuess < target) {
            currentGuess = parseInt(prompt("Enter a number higher than " + currentGuess + " between " + from + " and " + to));
            totalGuesses++;
